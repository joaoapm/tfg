// Classe que controla o mapa

function Mapa() {
	var isoGroup, cursorPos, cursor;
}

Mapa.prototype.carregaMapa = function() {
	...
	// This is used to set a game canvas-based offset for the 0, 0, 0 isometric
	// coordinate - by default
	// this point would be at screen coordinates 0, 0 (top left) which is
	// usually undesirable.
	game.iso.anchor.setTo(0.5, 0.2);
}

Mapa.prototype.criaMapa = function() {
...
Mapa.prototype.atualizaMapa = function() {
	...
	// determined from the 2D pointer position without extra trickery. By
	// default, the z position is 0 if not set.
